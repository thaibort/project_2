...
<div class="container-fluid pt-2" data-select2-id="34">
    <div data-select2-id="33">
        <a href="{{url('admin/staff')}}"><button aria-colspan="3" type="button"
                class="bg-blue text-white btn btn-primary">
        ...
        <div class="mt-3">
            ...
            <form action="{{url('admin/crestaff')}}" method="post" class="m-2">
                ...
                <input type="text" name="name" required class="form-control select2 select2-hidden-accessible"
                    style="width: 100%;" data-select2-id="1" tabindex="-1"><br>
                <label>Email:</label>
                <input type="email" name="email" required class="form-control select2 select2-hidden-accessible"
                    style="width: 100%;" data-select2-id="1" tabindex="-1"><br>
                <label>Số điện thoại:</label>
                <input type="text" name="phone" required class="form-control select2 select2-hidden-accessible"
                    style="width: 100%;" data-select2-id="1" tabindex="-1"><br>
                <label>địa chỉ:</label>
                <input type="text" name="address" required class="form-control select2 select2-hidden-accessible"
                    style="width: 100%;" data-select2-id="1" tabindex="-1"><br>
                <label> mật khẩu:</label>
                <input type="password" name="pass" required class="form-control select2 select2-hidden-accessible"
                    style="width: 100%;" data-select2-id="1" tabindex="-1"><br>
